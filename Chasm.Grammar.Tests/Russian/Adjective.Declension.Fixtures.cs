    ...
    public partial class RussianAdjectiveTests
    {
        [Pure] public static FixtureAdapter<DeclensionFixture> CreateDeclensionFixtures()
        {
            ...
            New("столетний", "п 2*a-")
                ...
                .Returns("столетняя, столетней, столетней, столетнюю, столетней, столетней, столетна")
                .Returns("столетние, столетных, столетним, столетних, столетними, столетних, столетни");
